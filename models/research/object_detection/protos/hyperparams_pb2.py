...
_HYPERPARAMS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='force_use_bias', full_name='object_detection.protos.Hyperparams.force_use_bias', index=7,
